...
#This is program that keeps your address book up to date. 

friends="/var/tmp/friends"

echo "Hello, $USER
. This script will register you in Michel's friends database. "

echo -n "Enter your name and press [EMTER]: "
read name
